...
#[[ "$PS1" ]] && archey4 && fortune -o

# sanitize TERM:
safe_term=${TERM//[^[:alnum:]]/?}
match_lhs=""

PS1="\[\e[94;1m\][\u@\[\e[36m\]\[\e[m\]\[\e[32;1m\]\h]\[\e[m\] \[\e[36m\]\W \[\e[m\]: "
PS2="> "
PS3="> "
PS4="+ "
...
alias risky='GIT_SSL_NO_VERIFY=true git clone '
alias jackin='iwctl station wlan0 connect'
alias mirrorupdate='sudo reflector --verbose --latest 5 --sort rate --save /etc/pacman.d/mirrorlist'
